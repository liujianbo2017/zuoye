...
public class MailUtils {
	  public static void sendMail(String address , String title , String content) throws AddressException, MessagingException {
	        ...
	        //设置发送者
	        message.setFrom(new InternetAddress("admin@itcast.com"));
