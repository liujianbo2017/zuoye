			...
			<div class="container-fluid">
				...
				<div class="col-md-3" style="padding-top:20px">
					<ol class="list-inline">
						...
						<%--判断Session中是否保存了用户对象，是则显示用户姓名等，否则显示登录、注册等超链接 --%>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						...
						<p><a href="${pageContext.request.contextPath }" style='color:#666'>${p.pname }</a></p>
						<p><font color="#E4393C" style="font-size:16px"><del>&yen;${p.market_price}</del>&yen;${p.shop_price}</font></p>
					</div>
					</c:forEach>
				</div>
			</div>
