...
public class PageBean<T> {
	...
	public String toString() {
		return "PageBean [data=" + data + ", pageNum=" + pageNum + ", pageSize=" + pageSize + ", recordCount="
				+ recordCount + ", pageCount=" + pageCount + ", startIndex=" + startIndex + "]";
	}
