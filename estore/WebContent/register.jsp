	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<!-- 提交给UserServlet的regist方法 -->
				<form action="${pageContext.request.contextPath}/user.servlet"
					...
					<div class="form-group">
						<label for="telephonecaption" class="col-sm-2 control-label">电话</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="telephonecaption"
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
							<label class="radio-inline"> <input type="radio"
								name="sex" id="inlineRadio1" value="m" checked>
								男
							</label> <label class="radio-inline"> <input type="radio"
								name="sex" id="inlineRadio2" value="f">
								女
							</label>
						</div>
					</div>
