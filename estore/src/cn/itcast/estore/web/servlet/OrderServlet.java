...
public class OrderServlet extends BaseServlet{
	...
	public String generate(HttpServletRequest req,HttpServletResponse resp) throws ServletException, IOException{
		...
		//提交过的商品,在购物车清空
		req.getSession().removeAttribute(Constant.SESSION_CART);
		...
		return req.getContextPath()+"/order.servlet?method=showMine";
	}
	...
	public String confirm(HttpServletRequest req,HttpServletResponse resp) throws ServletException, IOException{
		...
		//转跳页面
		req.setAttribute("msg", flag ? "付款成功!等待商家发货":"付款失败!请联系管理员");
		return "/info.jsp";
